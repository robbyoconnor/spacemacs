...
- [[#key-bindings][Key bindings]]
  ...
  - [[#diff-mode][Diff mode]]
  - [[#log-edit-buffer][Log Edit buffer]]
...
| Key binding    | Description                          |
|----------------+--------------------------------------|
| ~, ,~ or ~, c~ | Commit with message                  |
| ~, k~ or ~, a~ | Abort commit (saving message)        |
| ~, d~          | Show diff to be committed            |
| ~, f~          | Show files to be committed           |
| ~, w~          | Generate ChangeLog entries from diff |
